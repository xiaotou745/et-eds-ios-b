...
@implementation MDReciverInfoCell
{
    UIView * _bgView;
...
- (void)loadData:(id)data{
    ...
    _phoneNoLabel.text = model.receiverPhoneNo;
    
    _nameLabel.text = model.receiverName;
...
+ (CGFloat)calculateCellHeight:(id)data{
    ...
    CGSize size = [Tools stringHeight:model.receiverName fontSize:NormalFontSize width:(ScreenWidth - Space_Big - 70 - Space_Big)];
