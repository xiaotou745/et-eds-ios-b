...
@implementation OrderDetailSenderTableCell
...
- (void)loadData:(id)data{
    ...
    _phoneNoLabel.text = model.supermenPhone;
    
    _nameLabel.text = model.supermenName;
...
+ (CGFloat)calculateCellHeight:(id)data{
    ...
    CGSize size = [Tools stringHeight:model.supermenName fontSize:NormalFontSize width:(ScreenWidth - Space_Big - 70 - Space_Big)];
