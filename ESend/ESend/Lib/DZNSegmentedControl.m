...
- (void)initialize
{
    ...
    _selectionIndicator.backgroundColor = RedDefault;
...
- (void)configureSegments
{
    ...
    self.selectionIndicator.frame = [self selectionIndicatorRect];
    self.selectionIndicator.backgroundColor = RedDefault;
}
