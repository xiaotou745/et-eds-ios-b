...
static CGFloat const __imagePadding = 12.0f;
...
//        _contentView.layer.cornerRadius = 8.0f;
        ...
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(12, 12, 40, 40)];
        _imageView.contentMode = UIViewContentModeScaleAspectFill;
        _imageView.layer.cornerRadius = 4.0f;
        _imageView.clipsToBounds = YES;
        [self addSubview:_imageView];
        
        UIFont *textFont = [UIFont boldSystemFontOfSize:BigFontSize];
        ...
        UIFont *detailFont = [UIFont systemFontOfSize:NormalFontSize];
        CGRect detailFrame = CGRectMake(CGRectGetMinX(textFrame),
                                        CGRectGetMaxY(textFrame) + 5,
                                        notificationWidth - __imagePadding * 2 - CGRectGetMaxX(_imageView.frame),
