...
- (id)initWithDelegate:(id)delegate groupId:(NSString*)groupId {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"radio_nor"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"radio_pre"] forState:UIControlStateSelected];
...
- (CGRect)titleRectForContentRect:(CGRect)contentRect {
    CGFloat offsetWidth = self.marginWith ? self.marginWith : Q_ICON_TITLE_MARGIN;
    return CGRectMake(Q_RADIO_ICON_WH + offsetWidth, 0,
                      CGRectGetWidth(contentRect) - Q_RADIO_ICON_WH - offsetWidth,
