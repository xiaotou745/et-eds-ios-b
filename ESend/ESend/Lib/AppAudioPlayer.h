...
typedef enum AudioSystemType{
    AppAudioSystemTypeMessageReceived=0,
    AppAudioSystemTypeMessageSended,
    AppAudioSystemTypeMailReceived,
    AppAudioSystemTypeMailSended,
    AppAudioSystemTypeLocked,
    AppAudioSystemTypeUnLocked
    /*
...
{
    SystemSoundID systemSoundID;//系统声音的id 取值范围为：1000-2000
}
