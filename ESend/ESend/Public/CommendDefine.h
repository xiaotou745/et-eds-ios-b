...
#define ShanSongAddressMapPOISectedNotify @"ShanSongAddressMapPOISectedNotify" // 地图选择地址
    ...
    #define OPEN_API_SEVER @"http://api.edaisong.com/20160229/" //生产
    #define UPLOAD_IMAGE_API_SERVER @"http://upload.edaisong.com/20160229/" //上传图片地址
    #define UPDATE_APP_API_SERVER @"http://api.edaisong.com/" // 升级接口

    #define Java_API_SERVER @"http://japi.edaisong.com/20160229/services/" // java服务器-加密
